...
#[doc = "PWM timer0 working mode, 0: freeze, 1: increase mode, 2: decrease mode, 3: up-down mode\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum MOD {
